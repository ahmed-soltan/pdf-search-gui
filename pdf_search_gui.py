...
class PdfSearchApp:
    ...
    def browse_books_dir(self):
        """Allows user to select a different books directory."""
    ...
    def update_status(self, message, error=False, success=False):
        """Updates the status bar label, runs in the main GUI thread."""
        def _update():
    ...
    def display_results(self, results):
        """Displays search results in the text area, runs in the main GUI thread."""
        def _display():
    ...
    def _run_indexing(self):
        """The actual function run by the indexing thread."""
        try:
    ...
    def _run_search(self, query):
        """The actual function run by the search thread."""
        try:
    ...
    def _enable_buttons(self):
        """Helper to re-enable buttons in the main GUI thread."""
